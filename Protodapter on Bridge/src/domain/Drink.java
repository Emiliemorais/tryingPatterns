...
public class Drink extends Item {
	...
	public static final String GUAVA_FLAVOR = "Goiaba";
	...
	private Drink(Drink drinkPrototype){
		...
		setItemImplementor(drinkPrototype.getItemImplementor());
	}
	
	public Drink(int id, String name, Integer price, String size, String flavor, ItemImplementor itemImp){
	...
	protected String getDescription(){
		...
		String description = getItemImplementor().getDescription(this);
